...
const _openDbStore = async (dbName = AUTH_DB_NAME, storeName = OBJECT_STORE_NAME, version) => {
  if (isBrowser$1 && (localStorage == null ? void 0 : localStorage.getItem(KEY_STORAGE_DELEGATION))) {
...
function mkProduct(id, name, capacity, price, category, image, description, features) {
...
function filterProducts(products, query, category) {
  ...
  if (query.trim()) {
    ...
    result = result.filter(
      (p) => p.name.toLowerCase().includes(q) || p.capacity.toString().includes(q) || p.description.toLowerCase().includes(q)
    );
  }
  return result;
}
...
const Calculator$1 = createLucideIcon("calculator", __iconNode$j);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PackageSearch = createLucideIcon("package-search", __iconNode$b);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function CartLineItem({ item, index: index2 }) {
  const { removeItem, updateQuantity } = useCartStore();
  const lineTotal = item.product.price * item.quantity;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 py-4", "data-ocid": `cart.item.${index2}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-lg bg-muted flex-shrink-0 overflow-hidden border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-foreground text-sm leading-tight line-clamp-2", children: item.product.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            "data-ocid": `cart.delete_button.${index2}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 border border-border rounded-lg overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "data-ocid": `cart.qty_decrease.${index2}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { size: 12 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 text-center font-display font-bold text-sm", children: item.quantity }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              "data-ocid": `cart.qty_increase.${index2}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 12 })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-primary text-sm", children: formatPrice(lineTotal) })
      ] })
    ] })
  ] });
}
function CartSidebar() {
  ...
  const handleWhatsApp = () => {
    const itemLines = items.map(
      (i) => `${i.product.name} × ${i.quantity} @ ${formatPrice(i.product.price)}`
    ).join(", ");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-4 border-b border-border bg-primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { size: 18, className: "text-primary-foreground" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-primary-foreground text-base", children: "Your Cart" }),
              items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-secondary text-secondary-foreground font-bold text-xs px-2 py-0.5 rounded-full", children: items.reduce((s, i) => s + i.quantity, 0) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-5", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center justify-center h-full gap-4 py-16 text-center",
              "data-ocid": "cart.empty_state",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { size: 32, className: "text-muted-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-base", children: "Your cart is empty" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Add a tank to get started." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            CartLineItem,
            {
              item,
              index: idx + 1
          ...
          items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 border-t border-border bg-muted/40 flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-body text-sm", children: "Subtotal" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-foreground text-lg", children: formatPrice(total) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Delivery costs confirmed via WhatsApp." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                type: "button",
...
function Logo({ size = "md" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-2 ${scales[size]}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        viewBox: "0 0 40 48",
        ...
        "aria-hidden": "true",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "20", cy: "10", rx: "16", ry: "5", fill: "#F7941D" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "4", y: "10", width: "32", height: "28", fill: "#F7941D", rx: "1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "20", cy: "38", rx: "16", ry: "5", fill: "#c8720e" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: "4",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "20", cy: "10", rx: "8", ry: "2.5", fill: "#002147" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "16", y: "42", width: "8", height: "4", rx: "1", fill: "#002147" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
        ...
        style: {
          fontSize: size === "sm" ? "1.1rem" : size === "md" ? "1.4rem" : "1.8rem"
        },
        children: [
          "KENT",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary", children: "AINERS" })
        ]
      }
    )
  ] });
...
function Header() {
  const [_menuOpen, setMenuOpen] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      "data-ocid": "header",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary text-primary-foreground text-xs py-1.5 px-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "0785 152927"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70 hidden sm:inline", children: "Free delivery on orders above Ksh 50,000" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card/95 backdrop-blur-md px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "shrink-0", "data-ocid": "header.logo_link", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { size: "md" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSearch, className: "flex-1 relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Search,
                {
                  size: 16,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 bg-secondary text-white text-[10px] font-black w-5 h-5 rounded-full flex items-center justify-center", children: cartCount > 9 ? "9+" : cartCount })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "nav",
            {
              ...
              children: [
                CATEGORIES$1.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full left-0 pt-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-smooth z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-elevated p-4 min-w-52", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-primary text-sm mb-1", children: cat.label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mb-3", children: cat.desc }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Link,
                          {
                            to: cat.path,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card/95 px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSearch, className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Search,
            {
              size: 15,
    ...
    "nav",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            to: "/",
            className: `flex-1 flex flex-col items-center justify-center py-2 gap-1 text-[10px] font-display font-bold transition-colors ${isActive("/") ? "text-secondary" : "text-muted-foreground"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            to: "/products",
            className: `flex-1 flex flex-col items-center justify-center py-2 gap-1 text-[10px] font-display font-bold transition-colors ${isActive("/products") ? "text-secondary" : "text-muted-foreground"}`,
            "data-ocid": "mobile_nav.categories_link",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutGrid, { size: 22 }),
              "Categories"
            ]
          }
        ),
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative", children: [
                ...
                cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 bg-secondary text-white text-[9px] font-black w-4 h-4 rounded-full flex items-center justify-center", children: cartCount > 9 ? "9+" : cartCount })
              ] }),
              "Cart"
            ]
          }
...
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground py-6 px-4 hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-sm font-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary-foreground/80", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Kentainers. Quality Tanks, Reliable Service."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
...
function getRecommendedTank(neededLiters) {
  return WATER_TANKS.find((p) => p.capacity >= neededLiters) ?? WATER_TANKS[WATER_TANKS.length - 1] ?? null;
}
function Calculator() {
  var _a2;
  const [people, setPeople] = reactExports.useState(4);
  const [usage, setUsage] = reactExports.useState("medium");
  const [result, setResult] = reactExports.useState(null);
  const addItem = useCartStore((s) => s.addItem);
  const usageValue = ((_a2 = USAGE_OPTIONS.find((o) => o.key === usage)) == null ? void 0 : _a2.value) ?? 100;
  const handleCalculate = () => {
    const needed = people * usageValue * 30;
    const tank = getRecommendedTank(needed);
    setResult({ needed, tank });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "min-h-screen bg-background", "data-ocid": "calculator.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-primary py-10 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-secondary/20 border border-secondary/40 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator$1, { size: 28, className: "text-secondary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-black text-primary-foreground text-3xl sm:text-4xl leading-tight", children: "Tank Capacity Calculator" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-primary-foreground/70 font-body text-sm sm:text-base", children: "Tell us about your household — we'll find the perfect tank size." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border shadow-subtle p-6 sm:p-8 flex flex-col gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Label,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 16, className: "text-secondary" }),
                "Number of People"
              ]
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Enter a value between 1 and 20 people." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Label,
            {
              ...
              className: "font-display font-bold text-foreground flex items-center gap-2",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 16, className: "text-secondary" }),
                "Daily Usage Level"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "select",
              {
                ...
                children: USAGE_OPTIONS.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: o.key, children: [
                  o.label,
                  " — ",
                  o.value,
                  "L/person/day"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-muted/60 border border-border px-4 py-3 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: "Formula:" }),
          " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator$1, { size: 18, className: "mr-2" }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary px-6 py-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-black text-primary-foreground text-lg", children: "Recommended Tank" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/70 text-sm mt-0.5", children: [
            ...
            result.tank ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 p-6 items-start", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-xl bg-muted border border-border flex-shrink-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-black text-foreground text-base leading-tight", children: result.tank.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: result.tank.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mt-2 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-primary text-xl", children: formatPrice(result.tank.price) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs line-through", children: formatPrice(result.tank.marketValue) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "badge-savings text-[10px] px-1.5 py-0.5", children: [
                      "Save ",
                      result.tank.savingsPercent,
                      "%"
                    ] })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/60 rounded-xl px-4 py-3 flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Droplets,
                  {
                    size: 20,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-foreground text-sm", children: [
                    result.tank.capacity.toLocaleString(),
                    "L capacity"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs", children: [
                    "Covers ",
                    Math.round(result.tank.capacity / people),
                    "L/person/month with this tank."
                  ] })
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 p-6 pt-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    asChild: true,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", "data-ocid": "calculator.browse_link", children: "Browse All" })
                  }
                )
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 text-center text-muted-foreground font-body", children: [
...
function ProductCard({ product, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `product.item.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-muted flex items-center justify-center p-4 h-44", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: product.image,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              ...
              "data-ocid": `product.savings_badge.${index2}`,
              children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 p-4 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-sm leading-tight line-clamp-2", children: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs line-clamp-2", children: product.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-primary text-lg", children: formatPrice(product.price) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs line-through", children: formatPrice(product.marketValue) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Badge,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              "data-ocid": `product.add_button.${index2}`,
              children: [
...
function getRecommendation(people, usage) {
  ...
  const product = sorted.find((p) => p.capacity >= needed) ?? sorted[sorted.length - 1];
...
function Home() {
  ...
  const [people, setPeople] = reactExports.useState(4);
  const [usage, setUsage] = reactExports.useState("Medium");
  const [calcResult, setCalcResult] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "repeating-linear-gradient(45deg, transparent, transparent 20px, rgba(247,148,29,0.4) 20px, rgba(247,148,29,0.4) 21px)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-1 bg-secondary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto px-4 py-14 md:py-24 grid md:grid-cols-2 gap-10 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-secondary/20 border border-secondary/50 text-secondary text-xs font-display font-bold px-3 py-1 rounded-full mb-4", children: "🇰🇪 Kenya's #1 Tank Supplier" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-4xl md:text-5xl leading-tight mb-4", children: [
                "Premium Tanks,",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary", children: "Unbeatable Prices." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-primary-foreground/80 text-base md:text-lg mb-8 max-w-md", children: "Water tanks, septic systems & agricultural containers. Delivered across Kenya — save up to 20% vs. market price." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/products?cat=water", children: [
                      "Shop Water Tanks ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/calculator", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator$1, { size: 16 }),
                      " Tank Calculator"
                    ] })
                  }
                )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-4", children: [
                ...
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 12, className: "text-secondary" }),
                    badge
                  ]
                },
                badge
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex justify-center items-end gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 sm:grid-cols-3 gap-6", children: VALUE_PROPS.map(({ icon: Icon2, title, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-secondary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, className: "text-secondary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-sm", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-xs leading-relaxed mt-0.5", children: desc })
          ] })
        ] }, title)) })
      }
    ),
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-primary text-2xl", children: "Best-Selling Water Tanks" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Top-rated sizes for home, farm & business" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4", children: featured.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p, index: i + 1 }, p.id)) })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-secondary/10 flex items-center justify-center mx-auto mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator$1, { size: 24, className: "text-secondary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-primary text-2xl", children: "Capacity Calculator" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm mt-2", children: "Tell us your household size & usage — we'll find the right tank." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "label",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 15, className: "text-secondary" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-black text-primary text-xl w-14 text-center tabular-nums", children: [
                      people,
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body font-normal text-muted-foreground ml-1", children: "ppl" })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-sm", children: "Daily Usage Level" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("fieldset", { className: "flex gap-3 border-0 p-0 m-0", children: ["Low", "Medium", "High"].map((lvl) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => setUsage(lvl),
                      className: `flex-1 py-2.5 rounded-xl border text-sm font-display font-bold transition-smooth ${usage === lvl ? "bg-secondary text-white border-secondary" : "border-border text-muted-foreground hover:border-secondary/50"}`,
                      "data-ocid": `home.calculator.usage_${lvl.toLowerCase()}`,
                      children: lvl
                    },
                    lvl
                  )) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "Low = 50L/person/day · Medium = 100L · High = 150L (livestock/irrigation)" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator$1, { size: 18 }),
                      "Get Recommendation"
                    ]
                  }
                )
          ...
          calcResult && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
                calcResult.product && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs font-body", children: "Minimum recommended capacity" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-black text-primary text-2xl", children: [
                    calcResult.litres.toLocaleString(),
                    "L"
                  ] }),
                  calcResult.product && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-sm mt-1 leading-tight", children: calcResult.product.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-black text-secondary text-lg mt-0.5", children: formatPrice(calcResult.product.price) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          onClick: () => calcResult.product && addItem(calcResult.product),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-primary text-2xl", children: "Browse by Category" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm mt-1", children: "Find the right storage solution for every application" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: CATEGORIES.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/5 flex items-center justify-center h-36 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: cat.image,
                    alt: cat.label,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-black text-primary text-sm leading-tight", children: cat.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-xs mt-1 leading-relaxed line-clamp-2", children: cat.desc })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-secondary text-xs font-display font-bold group-hover:gap-2 transition-smooth", children: [
                  "Shop now ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-white text-2xl md:text-3xl", children: "Need Expert Advice?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 font-body text-sm mt-1", children: "Chat directly with our team. Bulk pricing, delivery quotes & custom orders." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-display font-bold text-base mt-1", children: "📞 0785 152 927" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
...
function Products() {
  ...
  const [sortKey, setSortKey] = reactExports.useState("default");
  const urlCat = searchParams.get("category") ?? searchParams.get("cat");
  const mappedCat = urlCat ? URL_TO_CAT[urlCat] ?? null : null;
  const effectiveCat = mappedCat ?? activeCategory;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/40 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-black text-primary text-2xl md:text-3xl mb-1 tracking-tight", children: "Product Catalog" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: TABS.map(({ key, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              role: "tab",
              ...
              className: `px-4 py-1.5 rounded-full text-sm font-display font-bold transition-smooth border ${effectiveCat === key ? "bg-primary text-primary-foreground border-primary shadow-subtle" : "bg-card text-muted-foreground border-border hover:border-secondary hover:text-secondary"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "p",
          {
            ...
            children: [
              ...
              "product",
              PRODUCTS.length !== 1 ? "s" : "",
              query && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary font-semibold", children: ` for "${query}"` })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 py-8", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center justify-center py-24 text-center gap-4",
        "data-ocid": "products.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-muted flex items-center justify-center mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PackageSearch, { size: 36, className: "text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg", children: "No products found" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs", children: query ? `No results for "${query}". Try a different search term or clear the filter.` : "No products in this category yet. Try selecting a different filter." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      "div",
      {
        ...
        children: filtered.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p, index: i + 1 }, p.id))
      }
    ) })
  ] });
}
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/calculator", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "*", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) })
  ] }) }) });
}
